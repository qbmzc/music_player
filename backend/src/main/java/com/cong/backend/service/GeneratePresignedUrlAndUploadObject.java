...
public class GeneratePresignedUrlAndUploadObject {
    ...
    public static void main(String[] args) {
        String bucketName = "tm-fs-test"; // Change bucket name.
        String keyName = "music/" + UUID.randomUUID()+"_"+"渡凉关.mp3";
...
//            OutputStreamWriter out = new OutputStreamWriter(connection.getOutputStream());
            String file = "/Users/cong/IdeaProjects/music-player/backend/src/main/resources/static/渡凉关.mp3";
            FileUtils.copyFile(new File(file), connection.getOutputStream());
